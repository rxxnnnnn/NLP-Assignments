...
class DependencyEdge(object):
    ...
    def __init__(self, ident, word, pos, head, deprel): 
        self.id = ident #position
        self.word = word
        self.pos = pos
        self.head = head #id of the parent word
        self.deprel = deprel #dependency label
...
class DependencyStructure(object):
    ...
    def __init__(self):
        self.deprels = {} #dict key: word_id value: DependencyEdge instances
        self.root = None #interger id of the root note
